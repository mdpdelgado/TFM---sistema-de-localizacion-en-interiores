...
import { Absolute2DPosition, AccuracyModifierNode, AngleUnit, CellIdentificationNode, DataFrame, DataObject, DataObjectService, FrameMergeNode, GraphBuilder, MemoryDataService, Model, ModelBuilder, MultilaterationNode, Orientation, PushOptions, CallbackNode } from '@openhps/core';
    ...
    protected initModel(): Promise<void> {
        return new Promise((resolve, reject) => {
            ModelBuilder.create()
				...
				/**
				.addService(objectDataService = new DataObjectService(new MongoDataServiceDriver(
                    DataObject, {
                        dbURL: "mongodb://admin:p%40ssw0rd@localhost:27017/?authSource=admin",
                        dbName: "ipin2021t-2"
                    })))
				*/
                ...
                .addShape(GraphBuilder.create()
                    ...
                    .via(new FrameMergeNode(
                        ...
                        {
                            timeout: 300,   // Timeout before pushing to the next node in ms // 300ms original
