...
import { RFTransmitterObject, RelativeRSSI, BLEObject } from '@openhps/rf';

/**
 * BLE source node using react-native-ble-plx.
 */
export default class BLESourceNode2 extends SourceNode<DataFrame> {
        ...
        return new Promise((resolve) => {
            ...
            this._manager.startDeviceScan(
                ...
                (error: any, device: Device) => {
                    ...
                    const beacon = new BLEObject(device.id);
